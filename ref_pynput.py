...
def function_2():
    ...
    print('Caught ctrl-c, pasting contents of clipboard below')
    sleep(0.01)  # nasty?
...
combination_to_function = {
    ...
    frozenset([Key.ctrl_l, KeyCode(vk=67)]): function_2,  # left ctrl + c
    frozenset([Key.shift, KeyCode(vk=81)]): quit,
}
